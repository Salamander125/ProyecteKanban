...
namespace ToDoListTest
{
    ...
    {
        string BaseUri;
        static public API_REST Instance = new API_REST();
        ...
        public async Task<Model.Tasca> GetTascaAsyncbyid(int Id)
        {
            Model.Tasca tasca = new Model.Tasca();
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    else
                    {
                        ...
                        tasca = await response.Content.ReadAsAsync<Model.Tasca>();
                        response.Dispose();
                    }
                }
                else
        ...
        /// Obté una llista de tots els Responsables de la base de dades
        /// </summary>
        public async Task<List<Model.Tasca>> GetAllTascaAsync()
        {
            List<Model.Tasca> tasca = new List<Model.Tasca>();
            ...
            using (var client = new HttpClient())
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    tasca = await response.Content.ReadAsAsync<List<Model.Tasca>>();
                    response.Dispose();
                }
                else
                {
        ...
        /// </summary>
        public async Task UpdateTascaAsync(Tasca tasca)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(BaseUri);
                ...
                // Construimos la URL según qué campo se quiera actualizar
                // Puedes enviar todo en un solo endpoint, por ejemplo PUT /tasca/{Codi}
        ...
        /// </summary>
        public async Task UpdateEstatTascaAsync(long Codi, int Estat)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(BaseUri);
                ...
                HttpResponseMessage response = await client.PutAsJsonAsync($"tasca/{Codi}/estat", Estat);
                response.EnsureSuccessStatusCode();
            }
        }
